...
async function main() {
    ...
    if (operation.operator === "Addition") {
        console.log(chalk.blue(`Addition of Enter Numbers is : ${operation.num1 + operation.num2}`));
    }
    else if (operation.operator === "Subtraction") {
        console.log(chalk.blue(`Subtraction of Enter Numbers is : ${operation.num1 - operation.num2}`));
    }
    else if (operation.operator === "Multiplication") {
        console.log(chalk.blue(`Multiplication of Enter Numbers is : ${operation.num1 * operation.num2}`));
    }
    else {
        console.log(chalk.blue(`Division of Enter Numbers is : ${operation.num1 / operation.num2}`));
    }
}
